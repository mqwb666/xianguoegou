...
<body onload="check()">
<div id="d1">
<form action="AdvertisingServlet?type=5" method="post" enctype="multipart/form-data">
<fieldset>
<legend><p style="text-align:center; font-family: 宋体; font-size: 30px">修改广告信息</p></legend>
				<div class="d2">
				...
				<input name="adname" type="text" style="width:200px;height:25px" value="${map.adname}"></input>
				</div>
				<br>
